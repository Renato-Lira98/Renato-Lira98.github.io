...
O código <<exa_cannypoints>> apresenta uma melhoria na técnica de pontilhismo e, usando em conjunto com o algoritimo de canny, foi possivel desenhar pontos na borda do rosto presente na imagem <<fig_biel>>. Na imagem <<fig_pontos_canny>>
